...
('11111', 'Parafuso', 'parafuso de aço', 0.5, 1000, 1, 1),
('22222', 'porca', 'porca de aço', 0.3, 2000, 1, 2),
('33333', 'arruela', 'arruela top', 0.2, 3000, 1, 3),
('44444', 'tubo hidráulico', 'tubo de alta pressão', 15.0, 500, 2, 4),
('55555', 'válvula', 'válvula de controle', 25.0, 200, 2, 5),
('66666', 'peça automotiva A', 'peça para motor', 100.0, 50, 3, 1),
('77777', 'peça automotiva B', 'peça para transmissão', 150.0, 30, 3, 2),
...
('10101', 'luvas de segurança', 'luvas resistentes a cortes', 10.0, 200, 4, 5);fdfdfsdfdsfsdfsefsdfes
