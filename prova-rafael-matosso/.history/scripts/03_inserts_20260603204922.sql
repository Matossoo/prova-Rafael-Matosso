...
insert into ordens_producao (data_producao, quantidade, status_producao, tempo_producao, tempo_real, id_produto, id_funcionario) VALUES
('2026-05-05', 5, 'Concluido', 1, 3, 11, 2),
('2026-05-06', 2, 'Concluido', 4, 3, 11, 1),
('2026-05-06', 9, 'Em produção', 8, 9, 13, 2),
('2026-05-07', 11, 'Concluido', 9, 10, 14, 3),
('2026-05-09', 18, 'Em produção', 6, 3, 15, 4),
('2026-05-12', 1, 'Em produção', 5, 3, 16, 5),
('2026-05-20', 0, 'Em produção', 2, 3, 11, 7),
('2026-05-21', 6, 'Concluido', 12, 17, 17 ,8),
('2026-05-22', 9, 'Concluido', 56, 60, 18, 1),
('2026-05-25', 21, 'Em produção', 11, 23, 17, 9),
('2026-05-27', 6, 'Concluido', 31, 32, 20, 2),
('2026-05-28', 7, 'Em produção', 1, 31, 20, 4),
('2026-05-29', 5, 'Concluido', 2, 13, 11,10),
('2026-05-30', 1, 'Em produção', 31, 13, 14,6),
('2026-06-01', 5, 'Em produção', 21, 22, 16, 8);

insert into registros_qualidade (data_inspecao, resultado, observacoes, id_ordem) values
('2026-06-03', 'Concluido', 'bom', 106),
('2026-06-05', 'Concluido', 'diferente', 106),
('2026-06-07', 'Concluido', 'interessante', 107),
('2026-06-08', 'Concluido', 'Nenhuma', 107),
('2026-06-09', 'Concluido', 'Nenhuma', 108),
('2026-06-09', 'Concluido', 'Otimo', 112),
('2026-06-10', 'Concluido', 'Nenhuma', 112),
('2026-06-21', 'Concluido', 'Nenhuma', 113),
('2026-06-22', 'Concluido', 'Nenhuma', 120),
('2026-06-22', 'Concluido', 'Nenhuma', 115);
